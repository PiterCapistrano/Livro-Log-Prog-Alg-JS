...
frm.addEventListener("submit", (e) => {
    ...
    if (media >= 7) {
        ...
        resp2.innerText = `Parabéns ${frm.inNome.value}! Você foi aprovado (a)`
        resp2.style.color = "blue"
    } else if (media >= 4) {
        resp2.innerText = `Atenção ${frm.inNome.value}. Você está em exame`
        resp2.style.color = "green"
    } else {
        resp2.innerText = `Ops ${frm.inNome.value}... Você foi reprovado(a)`
